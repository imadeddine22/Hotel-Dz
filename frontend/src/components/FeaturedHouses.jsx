...
import { Home, ChevronLeft, ChevronRight, MapPin, BedDouble, Bath, Users } from 'lucide-react';
    ...
    <section style={{ maxWidth: 1280, margin: '0 auto', padding: '48px 24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1e293b', margin: 0 }}>Locations de Maisons</h2>
            <p style={{ fontSize: 13, color: '#94a3b8', margin: '2px 0 0' }}>Villas, chalets, appartements en Algérie</p>
          </div>
        </div>
      ...
      <div style={{ position: 'relative' }}>
        ...
        >
          {houses.map((h) => {
            const img = h.images?.[0]?.url || h.img || 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&q=80';
